		...
		$.ajax({
			...
			success:function(result)
			{
				...
				for(var i=0;i<result['frules'].length;i++)
				{
					...
					$clone.html("<td>"+(i+1)+"</td><td>"+result['frules'][i]['formdesc']+"</td><td>"+get_form_chk(ddochkarr[result['frules'][i]['formref']])+"</td><td>"+get_form_chk(audchkarr[result['frules'][i]['formref']])+"</td><td><input type='radio' name='auditor_radio"+(i+1)+"' class='aud_chk_yes'/></td><td><input type='radio' name='auditor_radio"+(i+1)+"' class='aud_chk_no'/></td><td><input type='radio' name='auditor_radio"+(i+1)+"' class='aud_chk_na'/></td>");
