<?php
	...
	$q1=pg_fetch_array(pg_query("SELECT COUNT(*) FROM npayments WHERE billstatus='5' AND fyear='$finyear'"),null,PGSQL_ASSOC);
		...
		<div class="main_div_sub" style="height:800px;">
			...
			<div class="content_div">
				...
				<div class="other_content">
					...
					<h4 class="add_agency_txt" style="background:#474646;">You have <?php echo $q1['count']; ?> bills to be authorized.</h4>
