<?php
	...
	$username="fin";
	$rems=$_POST['rems'];
	$q11=pg_fetch_array(pg_query("SELECT gross FROM npayments WHERE transid='$tkno'"),null,PGSQL_ASSOC);
	$query=pg_query("UPDATE npayments SET billstatus=21 WHERE transid='$tkno'");
