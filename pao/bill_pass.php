...
<head>
	...
	<script type="text/javascript" src='../scripts/script_pao_pass.js'></script>
	<style>
	.scrutiny_table td{
		padding:5px;
		text-align:left;
					...
					<div class="agency_form">
						...
						<div class="bill_det_wrap" style="display:none;">
							...
							<div class="form_full_div" style="padding: 30px 240px;width: 200px;">
								<button type="button" class="save_agency pass_rej" id="bill_pass">Approve Bill</button>
							</div>
						</div>
					</div>
				</div>
