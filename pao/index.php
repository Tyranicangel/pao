<?php
	...
	$q1=pg_fetch_array(pg_query("SELECT COUNT(*) FROM npayments WHERE billstatus='4' AND fyear='$finyear'"),null,PGSQL_ASSOC);
	$q2=pg_fetch_array(pg_query("SELECT COUNT(*) FROM npayments WHERE billstatus='6' AND fyear='$finyear'"),null,PGSQL_ASSOC);
?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>PAO Login</title>
		...
		<div class="main_div_sub" style="height:800px;">
			...
			<div class="content_div">
				...
				<div class="other_content">
					...
					<h4 class="add_agency_txt" style="background:#474646;">You have <?php echo $q2['count']; ?> bills to be approved.</h4>
				</div>
				<div class="footer">
					<div class="copyright">
