<?php
	...
	$q21=pg_fetch_all(pg_query("SELECT * FROM (SELECT * FROM npayments WHERE auduser='$user_id') AS a INNER JOIN (SELECT * FROM chq_section) AS b ON a.transid=b.transid ORDER BY hoa"));
	$output=array();
	foreach ($q21 as $k) {
				...
				<table cellpadding="5" class="scrutiny_table abctab" border="1">
					...
					<tr>
						<?php
							...
							{
								echo "<tr><td class='td_scrutiny_no'>".$count."</td><td class='td_scrutiny_no'>".$key."</td><td class='td_scrutiny_no'>";
								if($value['s1audit'][0]==0)
								{
									echo '0';
								}else
								{
									echo "<a href='audit_bills/audit_s1audit.php?hoa=".$key."' target='_blank'>".$value['s1audit'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_s1supdt.php?hoa=".$key."' target='_blank'>".$value['s1sup'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_s1apao.php?hoa=".$key."' target='_blank'>".$value['s1apao'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_s1pao.php?hoa=".$key."' target='_blank'>".$value['s1pao'][0]."</a>";
								}
					...
					<tr>
						<?php
							...
							foreach($output as $key=>$value)
							{
								...
								{
									echo "<a href='audit_bills/audit_s2audit.php?hoa=".$key."' target='_blank'>".$value['s2audit'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_s2supdt.php?hoa=".$key."' target='_blank'>".$value['s2sup'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_s2apao.php?hoa=".$key."' target='_blank'>".$value['s2apao'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_s2pao.php?hoa=".$key."' target='_blank'>".$value['s2pao'][0]."</a>";
								}
					...
					<tr>
						<?php
							...
							foreach($output as $key=>$value)
							{
								...
								{
									echo "<a href='audit_bills/audit_bills_govt.php?hoa=".$key."' target='_blank'>".$value['govt'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_bills_auth.php?hoa=".$key."' target='_blank'>".$value['auth'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_bills_approved.php?hoa=".$key."' target='_blank'>".$value['approve'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_bills_ready.php?hoa=".$key."' target='_blank'>".$value['ready'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_bills_paid.php?hoa=".$key."' target='_blank'>".$value['paid'][0]."</a>";
								}
								...
								{
									echo "<a href='audit_bills/audit_token_rejected.php?hoa=".$key."' target='_blank'>".$value['reject'][0]."</a>";
								}
