<?php
	...
	$q21=pg_fetch_all(pg_query("SELECT * FROM (SELECT * FROM npayments WHERE blistuser='$user_id') AS a INNER JOIN (SELECT * FROM chq_section) AS b ON a.transid=b.transid ORDER BY passuser"));
					...
					<tr>
						<?php
							...
							foreach($output as $key=>$value)
							{
								...
								{
									echo "<a href='apao_bills/apao_s1audit.php?supt=".$key."' target='_blank'>".$value['s1audit'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_s1supdt.php?supt=".$key."' target='_blank'>".$value['s1sup'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_s1apao.php?supt=".$key."' target='_blank'>".$value['s1apao'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_s1pao.php?supt=".$key."' target='_blank'>".$value['s1pao'][0]."</a>";
								}
					...
					<tr>
						<?php
							...
							foreach($output as $key=>$value)
							{
								...
								{
									echo "<a href='apao_bills/apao_s2audit.php?supt=".$key."' target='_blank'>".$value['s2audit'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_s2supdt.php?supt=".$key."' target='_blank'>".$value['s2sup'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_s2apao.php?supt=".$key."' target='_blank'>".$value['s2apao'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_s2pao.php?supt=".$key."' target='_blank'>".$value['s2pao'][0]."</a>";
								}
					...
					<tr>
						<?php
							...
							foreach($output as $key=>$value)
							{
								...
								{
									echo "<a href='apao_bills/apao_bills_govt.php?supt=".$key."' target='_blank'>".$value['govt'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_bills_auth.php?supt=".$key."' target='_blank'>".$value['auth'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_bills_approved.php?supt=".$key."' target='_blank'>".$value['approve'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_bills_ready.php?supt=".$key."' target='_blank'>".$value['ready'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_bills_paid.php?supt=".$key."' target='_blank'>".$value['paid'][0]."</a>";
								}
								...
								{
									echo "<a href='apao_bills/apao_token_rejected.php?supt=".$key."' target='_blank'>".$value['reject'][0]."</a>";
								}
