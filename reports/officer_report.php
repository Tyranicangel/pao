<?php
	...
	$q21=pg_fetch_all(pg_query("SELECT * FROM (SELECT * FROM npayments WHERE blistuser='$user_id' AND billstatus='10') AS a INNER JOIN (SELECT * FROM chq_section) AS b ON a.transid=b.transid ORDER BY hoa"));
	$output=array();
	foreach ($q21 as $k) {
