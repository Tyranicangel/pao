<?php
	...
	$q1=pg_fetch_array(pg_query("SELECT COUNT(*) FROM chq_section WHERE counter='$counter' AND paymentstatus='0'"),null,PGSQL_ASSOC);
?>
<!doctype html>
<html lang="en">
<head>
		...
		<div class="main_div_sub" style="height:800px;">
			...
			<div class="content_div">
				...
				<div class="other_content">
					...
					<h4 class="add_agency_txt" style="background:#474646;">You have <?php echo $q1['count']; ?> ready bills.</h4>
