<?php
	...
	$q1=pg_fetch_array(pg_query("SELECT COUNT(*) FROM npayments WHERE blistuser='$user_id' AND billstatus='3' AND fyear='$finyear'"),null,PGSQL_ASSOC);
	$q2=pg_fetch_array(pg_query("SELECT COUNT(*) FROM npayments WHERE blistuser='$user_id' AND billstatus='7' AND fyear='$finyear'"),null,PGSQL_ASSOC);
	$q3=pg_fetch_array(pg_query("SELECT COUNT(*) FROM npayments WHERE blistuser='$user_id' AND billstatus='23' AND fyear='$finyear'"),null,PGSQL_ASSOC);
?>
<!doctype html>
<html lang="en">
<head>
	...
	<div class="main_div">
		<div class="main_div_sub" style="height:800px;">
			...
			<div class="content_div">
				...
				<div class="other_content" style='height:auto;'>
					...
					<h4 class="add_agency_txt" style="background:#474646;">You have <?php echo $q2['count']; ?> bills to be passed.</h4>
					<h4 class="add_agency_txt" style="background:#474646;">You have <?php echo $q3['count']; ?> bills to be rectified.</h4>
				</div>
				<div class="footer">
					<div class="copyright">
