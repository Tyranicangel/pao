...
<head>
	<meta charset="UTF-8">
	<title>Bill Rectify : Officer</title>
	...
	<script type="text/javascript" src='../scripts/script_officer_rectify.js'></script>
	<style>
	.scrutiny_table td{
		padding:5px;
		text-align:left;
		...
		<div class="main_div_sub">
			...
			<div class="content_div">
				...
				<div class="other_content" style="height:auto;padding-bottom:20px;margin-bottom:40px;">
					<h3 class="add_agency_txt" style="background:#474646;">Bill Rectify</h3>
								...
								<div class="form_full_div">
									...
									<div class="form_full_div" id='rmk_di_wrap'>
										<div class="input_div" style="width:680px;">
											<textarea id='remarks_area' style="width:400px;height:50px;resize:none;float:left" placeholder="Enter Remarks Here"></textarea>
										</div>
									</div>
								</div>
								<div class="form_full_div" style="padding: 30px 240px;width: 200px;">
									<button type="button" class="save_agency pass_rej" id="forward_to_supt">Forward to APAO/JPAO/DPAO</button>
								</div>
							</div>
						</div>
					</div>
