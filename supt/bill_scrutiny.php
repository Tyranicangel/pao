...
<head>
	<meta charset="UTF-8">
	<title>Bill Scrutiny : Supt</title>
	...
	<script type="text/javascript" src='../scripts/script_supt_scrutiny.js'></script>
	<style>
	.scrutiny_table td{
		padding:5px;
		text-align:left;
						...
						<div class="bill_det_wrap" style="display:none;">
							...
							<div class='scr_dets'>
								...
								<div class="form_full_div" style="padding: 30px 240px;width: 200px;">
									<button type="button" class="save_agency pass_rej" id="forward_to_supt">Forward to APAO/DPAO/JPAO</button>
								</div>
							</div>
						</div>
					</div>
