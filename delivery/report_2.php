<?php
	...
	while($r1=pg_fetch_array($q1,null,PGSQL_ASSOC))
	{
		...
		if(array_key_exists($q2['ddocode'],$output))
		{
			array_push($output[$q2['ddocode']],array($q2,$q3,$q4));
		}
		else
		{
			$output[$q2['ddocode']]=array();
			array_push($output[$q2['ddocode']],array($q2,$q3,$q4));
		}
	}
?>	
		...
		<div class="agency_form">
			<div class="form_full_div">
				<?php
					...
					{
						echo "<h4>".$v[0][2]['ddodesg']."(".$k.")</h4>";
						echo '<table cellpadding="5" class="scrutiny_table abctab" border="1"><tr class="ddo_scrutiny_table_tr"><td class="td_scrutiny_table">		S No</td><td class="td_scrutiny_table">DDO CODE</td><td class="td_scrutiny_table">No of Bills</td><td class="td_scrutiny_table">Bank Name</td><td class="td_scrutiny_table">IFSC Code</td><td class="td_scrutiny_table">Amount</td></tr>';
						$count=1;
						foreach($v as $m)
						{
							echo "<tr><td>$count</td><td>".$m[1]['partyname']."</td><td>".$m[0]['bankcode']."</td><td>".$m[1]['bankname']."</td><td>".$m[1]['bankcode']."</td><td>".$m[0]['gross']."</td></tr>";
							$count++;
						}
						echo "</table>";
						echo "<br><br><br><br>";
